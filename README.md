...
<ul>
    <h2>System Coupling &amp; Decoupling</h2>

<ul>
  <li>
    <strong>Transmission Bottlenecks:</strong>
    The analysis of the <em>“Puerto Montt Case”</em> reveals frequent system
    decoupling events, where Southern prices spike independently from the
    rest of the grid. This behavior highlights infrastructure bottlenecks
    preventing low-cost energy from the North from reaching the South.
  </li>
